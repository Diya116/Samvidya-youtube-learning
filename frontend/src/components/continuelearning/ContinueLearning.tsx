    ...
    // </div>
        ...
        {displayedCourses.map((course, index) => (
          <div
            ...
            className={`
              flex-shrink-0 w-48 h-24 rounded-lg border-2 p-3 cursor-pointer transition-all duration-300 hover:bg-primary/10 border-black/10
            `}
          >
            <div className="flex items-start gap-3 h-full">
              ...
              <div className="flex-1 min-w-0">
                {/* Title */}
                <h3 className={`text-xs font-medium mb-2 line-clamp-2 leading-tight dark:text-white text-gray-900`}>
                  {course.name}
                </h3>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between items-center">
                    ...
                    <ChevronRight className={`w-3 h-3  dark:text-gray-400 text-gray-500`} />
                  </div>
                  <div className={`w-full h-1 rounded-full dark:bg-gray-700 bg-gray-200`}>
                    <div
                      className={`h-1 rounded-full transition-all duration-500 bg-primary  dark:bg-white '
                      }`}
